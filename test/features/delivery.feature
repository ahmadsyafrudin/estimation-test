Feature: Client can estimate delivery
  ...
  Scenario: client estimate for their order on weekend
    Given client want to estimate weekend order on 3 February 2019 at 13:00:00 GMT+7
    When estimate for delivery on weekend
    Then client can't do order on Sunday
